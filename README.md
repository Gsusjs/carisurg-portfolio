# CariSurg Healthcare AI Portfolio (Weeks 0–8)
...
- `docs/` → literature review, feasibility memo, model-selection audit trail (`model-selection.md`), and handover document (`HANDOVER.md`)
